//compilar: mpicc 03-spawn-collective-worker.c -o 03-spawn-collective-worker
//executar: a partir do MPI_Comm_spawn do master

// codigo fonte 03-spawn-collective-worker.c;
// nome executavel 03-spawn-collective-worker
//
...
int main(int argc, char **argv)  
{
    ...
    char msg_0[50], msg_1[]="hi master", master_data[50], workers_data[50];
