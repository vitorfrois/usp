...
// mpirun -np 8 --host hostname:slots hellofor (segue -host e segue limitacoes. slots � opcional (default 1))
// mpirun --map-by node --hostfile ./halley.txt -np 4 ./hellofor : -np 4 ./hellofor  (espalha processos em n�s)
